...
@Component({
  selector: 'app-ingredientes-ejq',
  templateUrl: './ingredientes-ejq.page.html',
  styleUrls: ['./ingredientes-ejq.page.scss'],
})
export class IngredientesEjqPage implements OnInit {
