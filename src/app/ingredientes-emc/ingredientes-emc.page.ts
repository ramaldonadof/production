...
@Component({
  selector: 'app-ingredientes-emc',
  templateUrl: './ingredientes-emc.page.html',
  styleUrls: ['./ingredientes-emc.page.scss'],
})
export class IngredientesEmcPage implements OnInit {
