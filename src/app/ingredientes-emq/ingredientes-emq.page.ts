...
@Component({
  selector: 'app-ingredientes-emq',
  templateUrl: './ingredientes-emq.page.html',
  styleUrls: ['./ingredientes-emq.page.scss'],
})
export class IngredientesEmqPage implements OnInit {
